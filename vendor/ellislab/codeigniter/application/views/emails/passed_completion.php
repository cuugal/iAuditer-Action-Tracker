...
<nav class="navbar navbar-default">
    <div class="container">
        <div class="navbar-header page-scroll">
            ...
            <a class="navbar-brand page-scroll" href="http://localhost:8888/"><img src="http://localhost:8888/assets/images/Black-UTS-logo.png" height="30px"></a>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                ...
                A summary of the inspection item follows:
